...
``` r
mutate(pups_df, pd_walk_sub = pd_walk - 7)
```

    ## # A tibble: 313 × 7
    ##    litter_number   sex pd_ears pd_eyes pd_pivot pd_walk pd_walk_sub
...
Load pups, clean names, drop missing, keep litter_number and pd
variable, add pd walk - 7
...
sometimes the first thing isnt a dataframe
